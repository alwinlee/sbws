$(document).ready(function () {
    ...
    $('#send').click(function () {
        ...
        for(i=1;i<=nMemberCnt;i++)
        {
            ...
            paid1=0;paid2=0;paid3=0;joinday1=0;joinday2=0;joinday3=0;type=0;speccare=0;fami1=0;fami2=0;service1=0;service2=0;service3=0;
            ...
            if ($('#join3_'+i).is(':checked')){joinday3=1;traff3=$("#traffic3_"+i).val();fami3=$("#fami3_"+i).val();if(bPay){traffReal3=traff3;}}
            ...
            if(joinday1==0&&joinday2==0&&joinday3==0&&service1>0){
            ...
            if (bPaid==true){//管理窗口
                ...
                sqlcmd+="`day3`="+joinday3+",`family3`="+fami3+",`service3`="+service3+",`traff3`=&#&#"+traffitem3+"&#&#,`cost3`="+fee3+",`lock3`="+lock+",`pay3`="+paid3+",`regdate3`=&#&#"+regnewdate3+"&#&#,";
                ...
                sqlcmd+="`day3`="+joinday3+",`family3`="+fami3+",`service3`="+service3+",`traff3`=&#&#"+traffitem3+"&#&#,`cost3`="+fee3+",`regdate3`=&#&#"+regnewdate3+"&#&#,";
                sqlcmd+="`memo1`=&#&#"+txtMemo+"&#&#";
                sqlcmd+=clssqlcmd;
                sqlcmd+=" WHERE `idx`="+idx;
            }
