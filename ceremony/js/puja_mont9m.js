$(document).ready(function(){
    ...
    $('#send').click(function(){
        ...
        for(i=1;i<=nMemberCnt;i++)
        {
            ...
            if ($("#fami1_"+i).val()) { fami1 = parseInt($("#fami1_"+i).val());}
            if ($("#fami2_"+i).val()) { fami2 = parseInt($("#fami2_"+i).val());}
            if ($("#fami3_"+i).val()) { fami3 = parseInt($("#fami3_"+i).val());}
            if ($("#fami4_"+i).val()) { fami4 = parseInt($("#fami4_"+i).val());}
            if ($("#fami5_"+i).val()) { fami5 = parseInt($("#fami5_"+i).val());}
            if ($("#fami6_"+i).val()) { fami6 = parseInt($("#fami6_"+i).val());}
            jointotal += (fami1 + fami2 + fami3 + fami4 + fami5 + fami6);
            ...
            if(bPaid==true){//管理窗口
                ...
                sqlcmd+="`day1`="+joinday1+",`family1`="+fami1+",`meal1`="+meal1+",`specialcase1`="+mealx1+",`attend1`="+live1+",`traff1`=&#&#"+traffitem1+"&#&#,`cost1`="+fee1+",`lock1`="+lock+",`pay1`="+paid1+",`regdate1`=&#&#"+regnewdate1+"&#&#,";
                sqlcmd+="`paydate1`=&#&#"+paynewdate1+"&#&#,`paybyid1`=&#&#"+payernewid1+"&#&#,`paybyname1`=&#&#"+payernewname1+"&#&#,";

                sqlcmd+="`day2`="+joinday2+",`family2`="+fami2+",`meal2`="+meal2+",`specialcase2`="+mealx2+",`attend2`="+live2+",`traff2`=&#&#"+traffitem2+"&#&#,`cost2`="+fee2+",`lock2`="+lock+",`pay2`="+paid2+",`regdate2`=&#&#"+regnewdate2+"&#&#,";
                sqlcmd+="`paydate2`=&#&#"+paynewdate2+"&#&#,`paybyid2`=&#&#"+payernewid2+"&#&#,`paybyname2`=&#&#"+payernewname2+"&#&#,";

                sqlcmd+="`day3`="+joinday3+",`family3`="+fami3+",`meal3`="+meal3+",`specialcase3`="+mealx3+",`attend3`="+live3+",`traff3`=&#&#"+traffitem3+"&#&#,`cost3`="+fee3+",`lock3`="+lock+",`pay3`="+paid3+",`regdate3`=&#&#"+regnewdate3+"&#&#,";
                sqlcmd+="`paydate3`=&#&#"+paynewdate3+"&#&#,`paybyid3`=&#&#"+payernewid3+"&#&#,`paybyname3`=&#&#"+payernewname3+"&#&#,";

                sqlcmd+="`day4`="+joinday4+",`family4`="+fami4+",`meal4`="+meal4+",`specialcase4`="+mealx4+",`attend4`="+live4+",`traff4`=&#&#"+traffitem4+"&#&#,`cost4`="+fee4+",`lock4`="+lock+",`pay4`="+paid4+",`regdate4`=&#&#"+regnewdate4+"&#&#,";
                sqlcmd+="`paydate4`=&#&#"+paynewdate4+"&#&#,`paybyid4`=&#&#"+payernewid4+"&#&#,`paybyname4`=&#&#"+payernewname4+"&#&#,";

                sqlcmd+="`day5`="+joinday5+",`family5`="+fami5+",`meal5`="+meal5+",`specialcase5`="+mealx5+",`attend5`="+live5+",`traff5`=&#&#"+traffitem5+"&#&#,`cost5`="+fee5+",`lock5`="+lock+",`pay5`="+paid5+",`regdate5`=&#&#"+regnewdate5+"&#&#,";
                sqlcmd+="`paydate5`=&#&#"+paynewdate5+"&#&#,`paybyid5`=&#&#"+payernewid5+"&#&#,`paybyname5`=&#&#"+payernewname5+"&#&#,";

                sqlcmd+="`day6`="+joinday6+",`family6`="+fami6+",`meal6`="+meal6+",`specialcase6`="+mealx6+",`attend6`="+live6+",`traff6`=&#&#"+traffitem6+"&#&#,`cost6`="+fee6+",`lock6`="+lock+",`pay6`="+paid6+",`regdate6`=&#&#"+regnewdate6+"&#&#,";
                ...
                sqlcmd="UPDATE `"+tbname+"` "+"SET ";
                sqlcmd+="`day1`="+joinday1+",`family1`="+fami1+",`meal1`="+meal1+",`specialcase1`="+mealx1+",`attend1`="+live1+",`traff1`=&#&#"+traffitem1+"&#&#,`cost1`="+fee1+",`regdate1`=&#&#"+regnewdate1+"&#&#,";
                sqlcmd+="`day2`="+joinday2+",`family2`="+fami2+",`meal2`="+meal2+",`specialcase2`="+mealx2+",`attend2`="+live2+",`traff2`=&#&#"+traffitem2+"&#&#,`cost2`="+fee2+",`regdate2`=&#&#"+regnewdate2+"&#&#,";
                sqlcmd+="`day3`="+joinday3+",`family3`="+fami3+",`meal3`="+meal3+",`specialcase3`="+mealx3+",`attend3`="+live3+",`traff3`=&#&#"+traffitem3+"&#&#,`cost3`="+fee3+",`regdate3`=&#&#"+regnewdate3+"&#&#,";
                sqlcmd+="`day4`="+joinday4+",`family4`="+fami4+",`meal4`="+meal4+",`specialcase4`="+mealx4+",`attend4`="+live4+",`traff4`=&#&#"+traffitem4+"&#&#,`cost4`="+fee4+",`regdate4`=&#&#"+regnewdate4+"&#&#,";
                sqlcmd+="`day5`="+joinday5+",`family5`="+fami5+",`meal5`="+meal5+",`specialcase5`="+mealx5+",`attend5`="+live5+",`traff5`=&#&#"+traffitem5+"&#&#,`cost5`="+fee5+",`regdate5`=&#&#"+regnewdate5+"&#&#,";
                sqlcmd+="`day6`="+joinday6+",`family6`="+fami6+",`meal6`="+meal6+",`specialcase6`="+mealx6+",`attend6`="+live6+",`traff6`=&#&#"+traffitem6+"&#&#,`cost6`="+fee6+",`regdate6`=&#&#"+regnewdate6+"&#&#,";
...
function showtable(data,classid,classname,area,region,classfullname){
    ...
    table1+="<th></th>";// X
    table1+="<th colspan='3' style='width:240px;'>"+day1title+"</th>";
    ...
    table1 +="<th style=\"width:60px;\">參加</th><th style=\"width:60px;\">眷屬</th><th style=\"width:180px;\">交通</th>";
    ...
    for(w=1;w<partsArray.length;w++){
        ...
        fami1=parseInt(row[14]);fami2=parseInt(row[34]);fami3=parseInt(row[54]);fami4=parseInt(row[74]);fami5=parseInt(row[94]);fami6=parseInt(row[114]);
    ...
    $('.notjoin').click(function(event){
        ...
        for(wx=1;wx<=6;wx++){
            ...
            $('#fami'+wx+'_'+serial+' option[value="0"]').attr('selected', 'selected');
            $('#fami'+wx+'_'+serial).val("0").change();
            $('#fami'+wx+'_'+serial).prop('disabled',true);
    ...
    $('.join').click(function(event){
        ...
        if((day1+day2+day3+day4+day5+day6)<=0){
            ...
            for(ww=1;ww<=6;ww++){
                ...
                $('#fami' + ww + '_' + serial + ' option[value="0"]').attr('selected', 'selected');
                $('#fami' + ww + '_' + serial).val("0").change();
                $('#fami' + ww + '_' + serial).prop('disabled', true);
        ...
        if(dayvalue<=0){
            ...
            $('#fami'+item+'_'+serial+' option[value="0"]').attr('selected', 'selected');
            $('#fami'+item+'_'+serial).val("0").change();
            $('#fami'+item+'_'+serial).prop('disabled',true);
            ...
            $('#fami'+item+'_'+serial).prop('disabled',false);
    ...
    for(w=1;w<=6;w++){
        ...
        if($('#join'+w+'_'+index).is(':checked')){
            if($('#traffic'+w+'_'+index).val()!="Z"&&$('#traffic'+w+'_'+index).val()!="ZZ"){
                if(parseInt($('#trafficround'+w+'_'+index).val())==0){fee+=traffroundfee;ticket=traffroundfee;}//去回
                else if(parseInt($('#trafficround'+w+'_'+index).val())==1){fee+=traffgofee;ticket=traffgofee;}//去
                else if(parseInt($('#trafficround'+w+'_'+index).val())==2){fee+=traffbackfee;ticket=traffbackfee;}//回
                else {
                    fee += traffroundfee;
                    ticket=traffroundfee;
                }
            }
            if ($('#fami' + w + '_' + index).val()) {
                fee += ticket * parseInt($('#fami' + w + '_' + index).val());
            }
        }
...
function getfeebyitem(index,w){
    ...
    if($('#join'+w+'_'+index).is(':checked')){
        if($('#traffic'+w+'_'+index).val()!="Z"&&$('#traffic'+w+'_'+index).val()!="ZZ"){
            if(parseInt($('#trafficround'+w+'_'+index).val())==0){fee+=traffroundfee;ticket=traffroundfee;}
            else if(parseInt($('#trafficround'+w+'_'+index).val())==1){fee+=traffgofee;ticket=traffgofee;}
            else if(parseInt($('#trafficround'+w+'_'+index).val())==2){fee+=traffbackfee;ticket=traffbackfee;}
            else {
                fee += traffroundfee;
                ticket=traffroundfee;
            }
