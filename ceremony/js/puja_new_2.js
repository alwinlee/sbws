...
function showtable(data,classid,classname,area,region,classfullname){
    ...
    table1+="<th colspan=\"3\">"+day1title+"</th><th colspan=\"3\">"+day2title+"</th>";
    table1+="<th></th>";
    table1+="<th></th><th></th>";
    ...
    */
    ...
    table1+="<th style=\"width:40px;\">車資</th><th style=\"width:80px;\">備註</th>";
    ...
    for(w=1;w<partsArray.length;w++)
    {
        ...
        table1+="<td style='text-align:center;'><select style='width:110px' id='traffic1_"+(w)+"' class='traffic' serial='"+(w)+"' Item=1 idx='"+idx+"' name='traffic"+w+"' "+disableditem+disabledlock+">";
        ...
        table1+="<td style='text-align:center;'><input style='width:70px' id='memo_"+(w)+"' serial='"+(w)+"' idx='"+idx+"' class='memo' type='text'"+" value='"+row[29]+"'></td>";
