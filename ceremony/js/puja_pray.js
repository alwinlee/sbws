$(document).ready(function () {	
    ...
    $('#send').click(function () {
        ...
        for(i=1;i<=nMemberCnt;i++)
        {
            ...
            if($('#join1_'+i).is(':checked')){joinday1=1;traff1=$("#traffic1_"+i).val();traffround1=$("#trafficround1_"+i).val();if(bPay){traffReal1=traff1;traffroundReal1=traffround1;}}
            if($('#join2_'+i).is(':checked')){joinday2=1;traff2=$("#traffic2_"+i).val();traffround2=$("#trafficround2_"+i).val();if(bPay){traffReal2=traff2;traffroundReal2=traffround2;}}
            if($('#join3_'+i).is(':checked')){joinday3=1;traff3=$("#traffic3_"+i).val();traffround3=$("#trafficround3_"+i).val();if(bPay){traffReal3=traff3;traffroundReal3=traffround3;}}
            if($('#join4_'+i).is(':checked')){joinday4=1;traff4=$("#traffic4_"+i).val();traffround4=$("#trafficround4_"+i).val();if(bPay){traffReal4=traff4;traffroundReal4=traffround4;}}
            if($('#join5_'+i).is(':checked')){joinday5=1;traff5=$("#traffic5_"+i).val();traffround5=$("#trafficround5_"+i).val();if(bPay){traffReal5=traff5;traffroundReal5=traffround5;}}
            if($('#join6_'+i).is(':checked')){joinday6=1;traff6=$("#traffic6_"+i).val();traffround6=$("#trafficround6_"+i).val();if(bPay){traffReal6=traff6;traffroundReal6=traffround6;}}
            if (traffround1 == undefined) { traffround1 = 0; traffroundReal1 = 0;}
            if (traffround2 == undefined) { traffround2 = 0; traffroundReal2 = 0;}
            if (traffround3 == undefined) { traffround3 = 0; traffroundReal3 = 0;}
            if (traffround4 == undefined) { traffround4 = 0; traffroundReal4 = 0;}
            if (traffround5 == undefined) { traffround5 = 0; traffroundReal5 = 0;}
            if (traffround6 == undefined) { traffround6 = 0; traffroundReal6 = 0;}
            ...
            //fami1=$("#fami1_"+i).val();fami2=$("#fami2_"+i).val();
            ...
            if(bPaid==true){//管理窗口
                ...
                sqlcmd+="`day1`="+joinday1+",`meal1`="+meal1+",`traff1`=&#&#"+traffitem1+"&#&#,`cost1`="+fee1+",`lock1`="+lock+",`pay1`="+paid1+",`regdate1`=&#&#"+regnewdate1+"&#&#,";                
                sqlcmd+="`paydate1`=&#&#"+paynewdate1+"&#&#,`paybyid1`=&#&#"+payernewid1+"&#&#,`paybyname1`=&#&#"+payernewname1+"&#&#,";

                sqlcmd+="`day2`="+joinday2+",`meal2`="+meal2+",`traff2`=&#&#"+traffitem2+"&#&#,`cost2`="+fee2+",`lock2`="+lock+",`pay2`="+paid2+",`regdate2`=&#&#"+regnewdate2+"&#&#,";                
                sqlcmd+="`paydate2`=&#&#"+paynewdate2+"&#&#,`paybyid2`=&#&#"+payernewid2+"&#&#,`paybyname2`=&#&#"+payernewname2+"&#&#,";
 
                sqlcmd+="`day3`="+joinday3+",`meal3`="+meal3+",`traff3`=&#&#"+traffitem3+"&#&#,`cost3`="+fee3+",`lock3`="+lock+",`pay3`="+paid3+",`regdate3`=&#&#"+regnewdate3+"&#&#,";                
                sqlcmd+="`paydate3`=&#&#"+paynewdate3+"&#&#,`paybyid3`=&#&#"+payernewid3+"&#&#,`paybyname3`=&#&#"+payernewname3+"&#&#,";

                sqlcmd+="`day4`="+joinday4+",`meal4`="+meal4+",`traff4`=&#&#"+traffitem4+"&#&#,`cost4`="+fee4+",`lock4`="+lock+",`pay4`="+paid4+",`regdate4`=&#&#"+regnewdate4+"&#&#,";                
                sqlcmd+="`paydate4`=&#&#"+paynewdate4+"&#&#,`paybyid4`=&#&#"+payernewid4+"&#&#,`paybyname4`=&#&#"+payernewname4+"&#&#,";

                sqlcmd+="`day5`="+joinday5+",`meal5`="+meal5+",`traff5`=&#&#"+traffitem5+"&#&#,`cost5`="+fee5+",`lock5`="+lock+",`pay5`="+paid5+",`regdate5`=&#&#"+regnewdate5+"&#&#,";                
                sqlcmd+="`paydate5`=&#&#"+paynewdate5+"&#&#,`paybyid5`=&#&#"+payernewid5+"&#&#,`paybyname5`=&#&#"+payernewname5+"&#&#,";

                sqlcmd+="`day6`="+joinday6+",`meal6`="+meal6+",`traff6`=&#&#"+traffitem6+"&#&#,`cost6`="+fee6+",`lock6`="+lock+",`pay6`="+paid6+",`regdate6`=&#&#"+regnewdate6+"&#&#,";                
                ...
                sqlcmd="UPDATE `"+tbname+"` "+"SET ";                
                sqlcmd+="`day1`="+joinday1+",`meal1`="+meal1+",`traff1`=&#&#"+traffitem1+"&#&#,`cost1`="+fee1+",`regdate1`=&#&#"+regnewdate1+"&#&#,";
                sqlcmd+="`day2`="+joinday2+",`meal2`="+meal2+",`traff2`=&#&#"+traffitem2+"&#&#,`cost2`="+fee2+",`regdate2`=&#&#"+regnewdate2+"&#&#,";
                sqlcmd+="`day3`="+joinday3+",`meal3`="+meal3+",`traff3`=&#&#"+traffitem3+"&#&#,`cost3`="+fee3+",`regdate3`=&#&#"+regnewdate3+"&#&#,";
                sqlcmd+="`day4`="+joinday4+",`meal4`="+meal4+",`traff4`=&#&#"+traffitem4+"&#&#,`cost4`="+fee4+",`regdate4`=&#&#"+regnewdate4+"&#&#,";
                sqlcmd+="`day5`="+joinday5+",`meal5`="+meal5+",`traff5`=&#&#"+traffitem5+"&#&#,`cost5`="+fee5+",`regdate5`=&#&#"+regnewdate5+"&#&#,";
                sqlcmd+="`day6`="+joinday6+",`meal6`="+meal6+",`traff6`=&#&#"+traffitem6+"&#&#,`cost6`="+fee6+",`regdate6`=&#&#"+regnewdate6+"&#&#,";
    ...
    $('#prtinvoice').click(function () {
        ...
        var day5title=$('#day5title').val();
        var day6title=$('#day6title').val();
        ...
        parameter+='<input type="hidden" name="day3title" value="'+day3title+'" />';
        parameter+='<input type="hidden" name="day4title" value="'+day4title+'" />';
        parameter+='<input type="hidden" name="day5title" value="'+day5title+'" />';
        parameter+='<input type="hidden" name="day6title" value="'+day6title+'" />';
...
function showtable(data,classid,classname,area,region,classfullname) { 
    ...
    // Head ROW1
    var table1="<table class=\"reference\" id=\"fixheadertbl1\" style=\"width:1190px\" align=\"center\">";	
    table1+="<thead><tr>";
    table1+="<th></th><th></th>";//序 姓名
    table1+="<th></th>";// X 
    table1 +="<th colspan='3' style='width:120px;'>"+day1title+"</th>";
    table1 +="<th colspan='3' style='width:120px;'>"+day2title+"</th>";
    table1 +="<th colspan='3' style='width:120px;'>"+day3title+"</th>";
    table1 +="<th colspan='3' style='width:120px;'>"+day4title+"</th>";
    table1 +="<th colspan='3' style='width:120px;'>"+day5title+"</th>";
    table1 +="<th colspan='3' style='width:120px;'>"+day6title+"</th>";  
    ...
    */
    ...
    table1+="<th style=\"width:30px;\">參加</th><th style=\"width:30px;\">訂餐</th><th style=\"width:60px;\">交通</th>";
    table1 +="<th style=\"width:30px;\">參加</th><th style=\"width:30px;\">訂餐</th><th style=\"width:60px;\">交通</th>";
    table1 +="<th style=\"width:30px;\">參加</th><th style=\"width:30px;\">訂餐</th><th style=\"width:60px;\">交通</th>";
    table1 +="<th style=\"width:30px;\">參加</th><th style=\"width:30px;\">訂餐</th><th style=\"width:60px;\">交通</th>";
    table1 +="<th style=\"width:30px;\">參加</th><th style=\"width:30px;\">訂餐</th><th style=\"width:60px;\">交通</th>";
    ...
    table1+="<th style=\"width:50px;\">車資</th><th style=\"width:100px;\">備註</th>";
    if(payitem=="YES"){table1+="<th style=\"width:30px;\">繳費</th>";}	
    table1+="<th></th></thead><tbody><tr></tr>";
    ...
    for(w=1;w<partsArray.length;w++) {
        ...
        chkJoin="  ";disableditem=" disabled ";if(day1>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><select style='width:45px;' id='traffic1_"+(w)+"' class='traffic' serial='"+(w)+"' Item=1 idx='"+idx+"' name='traffic"+w+"' "+disableditem+disabledlock+">";
        for(kk=0;kk<trafftable1.length;kk+=2){selected=(traff1==trafftable1[kk] ? "selected":" ");table1+="<option value='"+trafftable1[kk]+"' "+selected+">"+trafftable1[kk]+"</option>";}//{table1 +="<option value='' "+trafftable[kk]+"-"+trafftable[kk+1]+"></option>";}
        table1 +="</select>&nbsp;";
        ...
        for(kk=0;kk<trafftable2.length;kk+=2){selected=(traff2==trafftable2[kk] ? "selected":" ");table1+="<option value='"+trafftable2[kk]+"' "+selected+">"+trafftable2[kk]+"</option>";}//{table1 +="<option value='' "+trafftable[kk]+"-"+trafftable[kk+1]+"></option>";}
        table1 +="</select>&nbsp;";
        ...
        //場3學員&餐&交通(去回)
        chkJoin="  ";disableditem=" disabled ";if(day3>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        ...
        chkJoin="  ";disableditem=" disabled ";if(day3>0){disableditem=" ";}if(meal3>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><input id='meal3_"+(w)+"' serial='"+(w)+"' Item=3 idx='"+idx+"' class='meal' type='checkbox'"+chkJoin+disableditem+disabledlock+"></td>";

        chkJoin="  ";disableditem=" disabled ";if(day3>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><select style='width:45px;' id='traffic3_"+(w)+"' class='traffic' serial='"+(w)+"' Item=3 idx='"+idx+"' name='traffic"+w+"' "+disableditem+disabledlock+">";
        for(kk=0;kk<trafftable3.length;kk+=2){selected=(traff3==trafftable3[kk] ? "selected":" ");table1+="<option value='"+trafftable3[kk]+"' "+selected+">"+trafftable3[kk]+"</option>";}//{table1 +="<option value='' "+trafftable[kk]+"-"+trafftable[kk+1]+"></option>";}
        table1 +="</select>&nbsp;";

        select0="";if(traffround3==0){select0=" selected ";}select1="";if(traffround3==1){select1=" selected ";}select2="";if(traffround3==2){select2=" selected ";}
        //table1+="<select style='width:55px' id='trafficround3_"+(w)+"' class='trafficround' serial='"+(w)+"' Item=3 idx='"+idx+"' name='trafficround"+w+"' "+disableditem+disabledlock+">";
        //table1+="<option value='0' "+select0+">去回</option><option value='1' "+select1+">去</option><option value='2' "+select2+">回</option>";
        //table1 +="</select></td>";

        //場4學員&餐&交通(去回)
        chkJoin="  ";disableditem=" disabled ";if(day4>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        ...
        chkJoin="  ";disableditem=" disabled ";if(day4>0){disableditem=" ";}if(meal4>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><input id='meal4_"+(w)+"' serial='"+(w)+"' Item=4 idx='"+idx+"' class='meal' type='checkbox'"+chkJoin+disableditem+disabledlock+"></td>";

        chkJoin="  ";disableditem=" disabled ";if(day4>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><select style='width:45px;' id='traffic4_"+(w)+"' class='traffic' serial='"+(w)+"' Item=4 idx='"+idx+"' name='traffic"+w+"' "+disableditem+disabledlock+">";
        for(kk=0;kk<trafftable4.length;kk+=2){selected=(traff4==trafftable4[kk] ? "selected":" ");table1+="<option value='"+trafftable4[kk]+"' "+selected+">"+trafftable4[kk]+"</option>";}//{table1 +="<option value='' "+trafftable[kk]+"-"+trafftable[kk+1]+"></option>";}
        table1 +="</select>&nbsp;";

        select0="";if(traffround4==0){select0=" selected ";}select1="";if(traffround4==1){select1=" selected ";}select2="";if(traffround4==2){select2=" selected ";}
        //table1+="<select style='width:55px' id='trafficround4_"+(w)+"' class='trafficround' serial='"+(w)+"' Item=4 idx='"+idx+"' name='trafficround"+w+"' "+disableditem+disabledlock+">";
        //table1+="<option value='0' "+select0+">去回</option><option value='1' "+select1+">去</option><option value='2' "+select2+">回</option>";
        //table1 +="</select></td>";

        //場5學員&餐&交通(去回)
        chkJoin="  ";disableditem=" disabled ";if(day5>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><input id='join5_"+(w)+"' serial='"+(w)+"' Item=5 idx='"+idx+"' class='join' type='checkbox'"+chkJoin+disabledlock+"></td>";
        
        chkJoin="  ";disableditem=" disabled ";if(day5>0){disableditem=" ";}if(meal5>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><input id='meal5_"+(w)+"' serial='"+(w)+"' Item=5 idx='"+idx+"' class='meal' type='checkbox'"+chkJoin+disableditem+disabledlock+"></td>";

        chkJoin="  ";disableditem=" disabled ";if(day5>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><select style='width:45px;' id='traffic5_"+(w)+"' class='traffic' serial='"+(w)+"' Item=5 idx='"+idx+"' name='traffic"+w+"' "+disableditem+disabledlock+">";
        for(kk=0;kk<trafftable5.length;kk+=2){selected=(traff5==trafftable5[kk] ? "selected":" ");table1+="<option value='"+trafftable5[kk]+"' "+selected+">"+trafftable5[kk]+"</option>";}//{table1 +="<option value='' "+trafftable[kk]+"-"+trafftable[kk+1]+"></option>";}
        table1 +="</select>&nbsp;";

        select0="";if(traffround5==0){select0=" selected ";}select1="";if(traffround5==1){select1=" selected ";}select2="";if(traffround5==2){select2=" selected ";}
        //table1+="<select style='width:55px' id='trafficround5_"+(w)+"' class='trafficround' serial='"+(w)+"' Item=5 idx='"+idx+"' name='trafficround"+w+"' "+disableditem+disabledlock+">";
        //table1+="<option value='0' "+select0+">去回</option><option value='1' "+select1+">去</option><option value='2' "+select2+">回</option>";
        //table1 +="</select></td>";

        //場6學員&餐&交通(去回)
        chkJoin="  ";disableditem=" disabled ";if(day6>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><input id='join6_"+(w)+"' serial='"+(w)+"' Item=6 idx='"+idx+"' class='join' type='checkbox'"+chkJoin+disabledlock+"></td>";

        chkJoin="  ";disableditem=" disabled ";if(day6>0){disableditem=" ";}if(meal6>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><input id='meal6_"+(w)+"' serial='"+(w)+"' Item=6 idx='"+idx+"' class='meal' type='checkbox'"+chkJoin+disableditem+disabledlock+"></td>";

        chkJoin="  ";disableditem=" disabled ";if(day6>0){chkJoin=" checked ";disableditem=" ";}else{chkJoin=" ";}
        table1+="<td style='text-align:center;'><select style='width:45px;' id='traffic6_"+(w)+"' class='traffic' serial='"+(w)+"' Item=6 idx='"+idx+"' name='traffic"+w+"' "+disableditem+disabledlock+">";
        for(kk=0;kk<trafftable6.length;kk+=2){selected=(traff6==trafftable6[kk] ? "selected":" ");table1+="<option value='"+trafftable6[kk]+"' "+selected+">"+trafftable6[kk]+"</option>";}//{table1 +="<option value='' "+trafftable[kk]+"-"+trafftable[kk+1]+"></option>";}
        table1 +="</select>&nbsp;";

        select0="";if(traffround6==0){select0=" selected ";}select1="";if(traffround6==1){select1=" selected ";}select2="";if(traffround6==2){select2=" selected ";}
        //table1+="<select style='width:55px' id='trafficround6_"+(w)+"' class='trafficround' serial='"+(w)+"' Item=6 idx='"+idx+"' name='trafficround"+w+"' "+disableditem+disabledlock+">";
        //table1+="<option value='0' "+select0+">去回</option><option value='1' "+select1+">去</option><option value='2' "+select2+">回</option>";
        //table1 +="</select></td>";        
        ...
        table1+="<td style='text-align:center;'><input style='width:90px' id='memo_"+(w)+"' serial='"+(w)+"' idx='"+idx+"' class='memo' type='text'"+" value='"+row[29]+"'></td>";
    ...
    table1+="</table>";	
    showdata +="<div id=\"tabs-1\" class=\"grid_x height450\" style=\"width:1190px;\">"+table1+"</div>";
    ...
    $('.notjoin').click(function(event) 
    {
        ...
        for(ww=1;ww<=6;ww++){
            $('#join'+ww+'_'+serial).prop('checked',false);
    ...
    $('.join').click(function(event) 
    {
        ...
        if((day1+day2+day3+day4+day5+day6)<=0){
            ...
            for(w=1;w<=6;w++){
                $('#traffic'+w+'_'+serial+' option[value="Z"]').attr('selected', 'selected');
                $('#traffic'+w+'_'+serial).val("Z").change();
                $('#traffic'+w+'_'+serial).prop('disabled',true);
                $('#trafficround'+w+'_'+serial+' option[value="0"]').attr('selected', 'selected');
                $('#trafficround'+w+'_'+serial).val("0").change();
                $('#trafficround'+w+'_'+serial).prop('disabled',true);
                $('#meal'+w+'_'+serial).prop('checked',false);
                $('#meal'+w+'_'+serial).prop('disabled',true);               
            }
            $('#fee_'+serial).text("0");
            $('#pay_'+serial).prop('checked',false);
            $('#pay_'+serial).prop('disabled',true);
