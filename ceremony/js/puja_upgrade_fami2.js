...
function showtable(data,classid,classname,area,region,classfullname){
    ...
    table1 +="<th style='width:35px;'>參加</th><th style='width:40px;'>福友</th><th style='width:40px;'>用餐</th><th style='width:90px;'>場次</th>";//<th style='width:30px;'>訂餐</th>";
    table1 +="<th style='width:35px;'>參加</th><th style='width:40px;'>福友</th><th style='width:40px;'>用餐</th><th style='width:90px;'>場次</th>";//<th style='width:30px;'>訂餐</th>";
    table1+="<th style='width:0px;'></th><th style='width:120px;'></th>";
    ...
    for(w=1;w<partsArray.length;w++)
    {
        ...
        */
        ...
        //車資
        table1+="<td style='text-align:center;'><div style='width:0px;display: none;' id='fee_"+(w)+"' class='fee' serial='"+(w)+"' idx='"+row[0]+"' name='fee"+w+"'>"+row[7]+"<div></td>";
