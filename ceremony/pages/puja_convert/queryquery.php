<?php
    ...
    if ($Major=="YES"){
        $sql="select * from `".$tbname."` WHERE (`CLS_ID`='".$classid."' AND `titleid`<5) ORDER BY Sex DESC, STU_ID ASC";
    }else{
        $sql="select * from `".$tbname."` WHERE (`CLS_ID`='".$classid."') ORDER BY Sex DESC, STU_ID ASC";
    }
