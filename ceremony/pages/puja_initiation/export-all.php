<?php
    ...
    {
        if ($orderbydate=="YES"){$sql="SELECT * FROM ".$table_name." WHERE (`day1`>10000000 OR `day2`>0) ORDER BY `regdate` ASC,`CLS_ID` ASC,`TTL_ID` ASC,`memberseq` ASC, `idx` ASC";}
        else{$sql="SELECT * FROM ".$table_name." WHERE (`day1`>10000000 OR `day2`>0) ORDER BY `CLS_ID` ASC,`TTL_ID` ASC,`memberseq` ASC, `idx` ASC";}
    }
    else
    {
        $Car=false;
        ...
        if ($orderbydate=="YES"){$sql="SELECT * FROM ".$table_name." WHERE ((`day1`>10000000 OR `day2`>0) ".$areakey.") ORDER BY `regdate` ASC,`CLS_ID` ASC,`TTL_ID` ASC,`memberseq` ASC,`idx` ASC";}
        else{$sql="SELECT * FROM ".$table_name." WHERE ((`day1`>10000000 OR `day2`>0) ".$areakey.") ORDER BY `CLS_ID` ASC,`TTL_ID` ASC,`memberseq` ASC, `idx` ASC";}
    }
