<?php
    ...
    while($traffic_row = mysql_fetch_array($pujatraffic_result, MYSQL_ASSOC))
    {
        ...
        $traffinfo1[$i][1]=$traffic_row["traffname"]."[2/19(一)(初四）]";
        $traffinfo1[$i][2]=0;
        $traffinfo1[$i][3]="";
        $traffinfo1[$i][4]=0;
        $i++;
    ...
    while($traffic_row = mysql_fetch_array($pujatraffic_result, MYSQL_ASSOC))
    {
        ...
        $traffinfo2[$i][1]=$traffic_row["traffname"]."2/20(二)(初五）";;
        $traffinfo2[$i][2]=0;
        $traffinfo2[$i][3]="";
        $traffinfo2[$i][4]=0;
        $i++;
    ...
    // puja configure
    $sql        ="SELECT * FROM pujaconfig WHERE `php`='puja_new.php'"; // 取得法會資料設定值
