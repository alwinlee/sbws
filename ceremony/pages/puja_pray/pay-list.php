<?php
    ...
    $tablehtml_header.="<td width=\"480px\" colspan=\"6\">搭車車次</td>";
    $tablehtml_header.="<td width=\"80px\" rowspan=\"2\">車資</td></tr>";
    $tablehtml_header.="<tr align=\"center\"><td width=\"80px\">".$day1title."</td><td width=\"80px\">".$day2title."</td><td width=\"80px\">".$day3title."</td>";
    $tablehtml_header.="<td width=\"80px\">".$day4title."</td><td width=\"80px\">".$day5title."</td><td width=\"80px\">".$day6title."</td></tr>"; 
    ...
    {		
        ...
        while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            ...
            if (($trafflist1[3]=="Z"||$trafflist1[3]== "ZZ"||$trafflist1[3]=="")&&($trafflist2[3]=="Z"||$trafflist2[3]== "ZZ"||$trafflist2[3]=="")&&
                ($trafflist3[3]=="Z"||$trafflist3[3]== "ZZ"||$trafflist3[3]=="")&&($trafflist4[3]=="Z"||$trafflist4[3]== "ZZ"||$trafflist4[3]=="")&&
                ($trafflist4[3]=="Z"||$trafflist5[3]== "ZZ"||$trafflist5[3]=="")&&($trafflist6[3]=="Z"||$trafflist6[3]== "ZZ"||$trafflist6[3]==""))
                {continue;}
            ...
            $rowitem.="<td>".$day1."</td><td>".$day2."</td><td>".$day3."</td><td>".$day4."</td><td>".$day5."</td><td>".$day6."</td>";
