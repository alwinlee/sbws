<?php
    ...
    $table_title=$_POST["pujatitle"]." 車資繳費單 (".$classname."班)";
    ...
    $puja_result=mysql_query($sql);
    $numrows    =mysql_num_rows($puja_result);
    ...
    if ($numrows > 0)
    {
        $puja_row=mysql_fetch_array($puja_result, MYSQL_ASSOC);
    ...
    for($j=0; $j < $iSize1; $j++)
    {
        ...
        $trafftablehtml .= "<tr><td> ".$traffinfo1[$j][1]."-".$daytitle[0]."</td><td> ".$traffinfo1[$j][0]."</td>";
        $trafftablehtml .= "<td>".$day1student."</td>";
       // $trafftablehtml .= "<td align=\"right\"> ".($iDay1 > 0 ? $iDay1 : "-")."  </td>";
        $trafftablehtml .= "<td align=\"right\"> ".$iSum." x ".$fee."</td></tr>";
    ...
    for($j=0; $j < $iSize2; $j++)
    {
        ...
        $trafftablehtml .= "<tr><td> ".$traffinfo2[$j][1]."-".$daytitle[1]."</td><td> ".$traffinfo2[$j][0]."</td>";
