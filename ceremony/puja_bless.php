...
<SCRIPT src="./js/puja_bless.js?{BCB1FD17-B5F3-4340-A3D3-175FC1464387}" type="text/javascript"></SCRIPT>
...
<?php
    ...
    echo "<br><table align='center' style='width:900px;'>";
    ...
    $place = "<input type='hidden' id='joinplace' class='joinplace' name='joinplace'";
    $place .= " value='0,-;1,高雄學苑;2,華榮教室;3,文化教室;4,小港教室;5,仁武教室;6,河堤教室;7,屏東支苑;8,東港教室;9,萬丹教室;10,恆春教室;' />";
    echo $place;
?>
<DIV>
</TD></TR>
