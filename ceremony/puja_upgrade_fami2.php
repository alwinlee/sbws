...
<SCRIPT src="./js/puja_upgrade_fami2.js?{2249ADF6-F1F0-49EF-AA9F-470B457BBCB5}" type="text/javascript"></SCRIPT>
...
<?php
    ...
    echo "<input type='hidden' id='joinplace' class='joinplace' name='joinplace' value='-;左營中心;鳳仁教室;圓明寺;中正教室;小港教室;高雄學苑;旗山教室;台東教室;澎湖教室;屏東南海寺;' />";
?>
<DIV>
</TD></TR>
</TABLE>
