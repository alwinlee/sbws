...
<SCRIPT src="./js/puja_wisdom_phase2.js?{BCB1FD17-B5F3-4340-A3D3-175FC1464387}" type="text/javascript"></SCRIPT>
...
<?php
    ...
    $substring1=['增', '善', '備', '宗']; //$substring1=['19增', '20增', '21增', '22增'];
